...
import { villagesRouter } from './modules/villages/villages.routes';
import { partnerTypesRouter } from './modules/partnerTypes/partnerTypes.routes';
import { assetTypesRouter } from './modules/assetTypes/assetTypes.routes';
import { assetsRouter } from './modules/assets/assets.routes';
import { inventoryMovementsRouter } from './modules/inventoryMovements/inventoryMovements.routes';
import { storePricingRouter } from './modules/storePricing/storePricing.routes';
import { productsRouter } from './modules/products/products.routes';
import { suppliersRouter } from './modules/suppliers/suppliers.routes';
import { purchasesRouter } from './modules/purchases/purchases.routes';
import { purchaseOrderRequestsRouter } from './modules/purchaseOrderRequests/purchaseOrderRequests.routes';
...
app.use('/api/partner-types', partnerTypesRouter);
...
app.use('/api/purchase-order-requests', purchaseOrderRequestsRouter);
